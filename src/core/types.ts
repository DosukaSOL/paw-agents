...
export type ChannelType = 'telegram' | 'discord' | 'slack' | 'whatsapp' | 'webchat' | 'api' | 'email' | 'sms' | 'line' | 'reddit' | 'matrix' | 'desktop' | 'hub' | 'mission-control' | 'voice' | 'twitter' | 'github' | 'notion' | 'calendar' | 'rest' | 'mqtt' | 'rss' | 'system';
...
export interface GatewayMessage {
  type: 'message' | 'command' | 'event' | 'response' | 'stream' | 'hub_control';
  channel: ChannelType;
  from: string;
  payload: unknown;
  timestamp: string;
